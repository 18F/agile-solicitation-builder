...
deliverables = [
    ...
    {
        "name": "legacySystems",
        "text": "Please provide more detail about the legacy applications and/or systems the contractor will be expected to maintain. Any information about the technology currently being used, when the application was built, etc.",
